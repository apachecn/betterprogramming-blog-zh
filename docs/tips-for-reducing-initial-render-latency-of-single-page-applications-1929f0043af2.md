...
spa 使用 Webpack、Rollup、Vite 等模块打包器将你在整个应用程序中编写的所有 JavaScript(以及从`node_modules`开始你需要的所有代码)打包成一个大规模的 JavaScript 文件，然后将你编写的所有 CSS 打包成一个大规模的 CSS 文件。
...
![](img/941a01eba7e6f824ec7892d4a11bcae2.png)
