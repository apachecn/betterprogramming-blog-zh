...
![](img/996a2b5a5b85d1d9540c62d001042906.png)
...
*   页面生成也是一个很大的缺点，因为它不适合内容或用户生成内容的快速变化。
...
对于即时发生的事情，不需要发送额外的请求来加载新页面。有时需要发送请求来获取新数据。
