...
在大多数情况下，管理人员没有理解这样一个事实，即优先考虑技术债务对于平稳、不间断的开发是至关重要的——这在未来节省了时间和精力。这是一项长期投资。
...
![](img/575f18851d555c937719bfefdab8d02d.png)
...
对糟糕的编码实践最常见的反应是屈服。等待别人做某事，因为这很简单。但是简单不会让你的工作变得更简单。
